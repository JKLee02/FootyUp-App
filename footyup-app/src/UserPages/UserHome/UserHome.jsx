                ...
                <div className="user-home-container">
                    <div className="user-options-container">
                        <div className="option-box">
                            ...
                            <p>Still yet to decide on which tournament to play? Click here to browse all of the available tournaments!</p>
                            <Link to="/usertournaments" className="option-btn">Let's go</Link>
                        </div>

                        <div className="option-box">
                            <h3>Host a tournament</h3>
                            <p>Wanna be the host for a tournament? You can start by clicking this button here!</p>
                            <Link to="/usertournaments" className="option-btn">Let's go</Link>
                        </div>

                        <div className="option-box">
                            <h3>Join a team</h3>
                            <p>Still thinking on which team to join or just wanna take a look at the community? Here it can decide all of that for you!</p>
                            <Link to="/userteam" className="option-btn">Let's go</Link>
                        </div>
                    </div>
                </div>
            </main>
