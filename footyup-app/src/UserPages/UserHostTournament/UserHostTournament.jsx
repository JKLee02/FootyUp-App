          ...
          <form className="user-host-tournament-form" onSubmit={handleSubmit}>
            <div className="user-host-form-left">
              ...
              <div className="user-host-form-note">
                Note: Tournaments are currently in a single elimination format
                with only 4 teams and only 5-a-side teams are allowed to join.
                In addition, the tournament will only be displayed in the
                tournaments page after its approval from the admin.
              </div>
              ...
              <div className="user-host-form-buttons">
                ...
                <button
                  type="button"
                  className="user-host-cancel-button"
            ...
            <div className="user-host-form-right">
              ...
              <p className="user-host-venue-address">
